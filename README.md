...
## **27.10.2024**
- Создан ПланОбмена Д_ОбменСМобильнымУстройством. Добавлен новый шаблон URL ExchangeDelivery в HTTP-сервис Д_ОбменСМобильнымКлиентом. В модуле объекта документа Д-Доставка в событии ПриЗаписи создана  регистрация документа на узлах плана обмена, согласно условия;