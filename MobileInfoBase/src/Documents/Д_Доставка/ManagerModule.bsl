...
// 16 октября 2024 г.
	...
	Если ПечатнаяФорма <> Неопределено Тогда
	    ...
	    ПечатнаяФорма.ПолныйПутьКМакету = "Документ.ДЗ_Расширения_Доставка.ПФ_MXL_АнкетаКлиента";
	КонецЕсли;
	...
	Если ПечатнаяФорма <> Неопределено Тогда
	    ...
	    ПечатнаяФорма.ПолныйПутьКМакету = "Документ.ДЗ_Расширения_Доставка.ПФ_MXL_ТранспортнаяНакладная";
	КонецЕсли;
// Конец вставки от 16 октября 2024 г.
КонецПроцедуры
...
// 16 октября 2024 г.
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ДЗ_Расширения_Доставка.ПФ_MXL_АнкетаКлиента");
...
// 16 октября 2024 г.
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ДЗ_Расширения_Доставка.ПФ_MXL_ТранспортнаяНакладная");
