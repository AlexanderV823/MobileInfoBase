...
//Итоговая работа по модулю Мобильная разработка в 1С
	...
	Пока Выборка.Следующий() Цикл
		...
		ДокументДоставки.Вставить("Контрагент", Строка(Выборка.Контрагент.УникальныйИдентификатор()));
		...
		Пока ВыборкаТовары.Следующий() Цикл
			...
			СтрокаТаблицыТовары.Вставить("Номенклатура", Строка(ВыборкаТовары.Номенклатура.Ссылка.УникальныйИдентификатор()));
